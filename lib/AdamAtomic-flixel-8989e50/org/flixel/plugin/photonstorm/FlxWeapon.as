...
package org.flixel.plugin.photonstorm 
{
	...
	public class FlxWeapon 
	{
		...
		protected var parentAimVariable:String;
		 ...
		 */
		public function FlxWeapon(name:String, parentRef:* = null, xVariable:String = "x", yVariable:String = "y", aimVariable:String = "aim")
		{
			this.name = name;
			...
			if (parentRef)
			{
				setParent(parentRef, xVariable, yVariable, aimVariable);
			}
		}
		...
		protected function runFire(method:uint, x:int = 0, y:int = 0, target:FlxSprite = null, angle:int = 0, missleOverdrive:Boolean = true, bulletShells:FlxEmitter = null):Boolean
		{
			...
			if (onPostFireSound && missleOverdrive)
			{
		 ...
		 * @return	true if a bullet was fired or false if one wasn't available. A reference to the bullet fired is stored in FlxWeapon.currentBullet.
		 */
		public function fireFromAngle(angle:int, missleOverdrive:Boolean = true, bulletShells:FlxEmitter = null):Boolean
		{
			return runFire(FIRE_FROM_ANGLE, 0, 0, null, angle, missleOverdrive, bulletShells);
		}
		 ...
		 */
		public function setParent(parentRef:*, xVariable:String, yVariable:String, aimVariable:String, offsetX:int = 0, offsetY:int = 0, useDirection:Boolean = false):void
		{
			if (parentRef)
			{
				fireFromParent = true;
