...
package org.flixel.plugin.photonstorm 
{
	...
	public class FlxDisplay 
	{
		...
		/**
		 * Centers the given FlxRect on the screen, either by the X axis, Y axis, or both
		 * 
		 * @param	source	The FlxRect to center
		 * @param	xAxis	Boolean true if you want it centered on X (i.e. in the middle of the screen)
		 * @param	yAxis	Boolean	true if you want it centered on Y
		 * 
		 * @return	The FlxRect for chaining
		 */
		public static function screenCenterFlxRect(source:FlxRect):void
		{
			source.x = (FlxG.camera.scroll.x + FlxG.width / 2) - (source.width / 2);
			source.y = (FlxG.camera.scroll.y + FlxG.height / 2) - (source.height / 2);
		}
